...
providing a Bioconductor-like data frame class, and the 
...
Additionally, BiocPy introduces infrastructure packages supporting delayed operations 
([DelayedArray](https://github.com/BiocPy/DelayedArray)) and incorporates various 
generics and utilities in [BiocUtils](https://github.com/BiocPy/BiocUtils). 
While there have been previous efforts to port bioconductor representations into 
Python e.g. AnnData, plyranges, these efforts are fragmented and have limited interoperability.
...
rds2cpp library. This enables the direct reading of RDS files in Python, eliminating 

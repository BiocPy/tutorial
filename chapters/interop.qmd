...
You can continue to convert this object into `AnnData` representation and perform analysis. For more details on `SingleCellExperiment`, refer to the documentation [here](./experiments/singlecell_expt.qmd).

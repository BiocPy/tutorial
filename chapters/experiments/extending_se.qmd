...
We need accessors and setters so users can interact with this new property. We provide these accessors in both functional and property-based approaches. More details can be found in our [class design](../philosophy.qmd#class-design) document.
...
```{python}
#| code-fold: true
#| code-summary: "Show the full class"
